    ...
    <div class="main">
        ...
        <div :style="backgound">
            ...
            <div class="demo-basic--circle">
                <div class="block">
                    ...
                    <div data-v-52441f16="" class="level flex-center transition" style="">
                        <i data-v-52441f16="" class="iconfont icon-level nicelevel-1"></i>
                    </div>
        ...
        <div class="section">
            ...
            <div>
                <ul id="example-2">
                    <li>
                       <router-link to="/singer/songs">作品</router-link>
                    </li>
                    <li>
                        <a>专辑</a>
                    </li>
                    ...
                    <li>
                        <router-link to="/singer/work">歌手详情</router-link>
                    </li>
                    <li>
                        <a>相似歌手</a>
                    </li>
...
<style lang="less">
    ...
    .singer-detail .singer-info .top .top-mask .singer-box .avatar .level[data-v-52441f16] {
        width: 100%;
        height: 25px;
        position: absolute;
        left: 0;
